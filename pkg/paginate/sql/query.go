...
func WriteQuery(table string, filters map[paginate.FilterParameter]paginate.Filter, sortColumn string, descending bool, limit, offset uint64) (query string, countQuery string, args []interface{}) {
